    ...
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form @submit.prevent="saveProjectChanges">
                    <div class="grid gap-4 mb-4">
                        <div>
                            <label for="edit-project-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Project Name</label>
                            <input 
                                type="text" 
                        ...
                        <div>
                            <label for="edit-project-description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                            <textarea 
                                id="edit-project-description"
                                x-model="editingProject.shortDescription"
                                rows="4"
